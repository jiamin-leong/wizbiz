  ...
  return (
    <div className="min-h-screen bg-amber-50 flex items-center justify-center">
      <div className="bg-white rounded-2xl shadow-md p-8 w-full max-w-sm">
        <h1 className="text-2xl font-bold text-amber-600 mb-1">WizBiz Admin</h1>
        ...
        <form action={handleSubmit} className="flex flex-col gap-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="bg-amber-500 text-white rounded-lg py-2 font-semibold hover:bg-amber-600 transition disabled:opacity-50"
          >
